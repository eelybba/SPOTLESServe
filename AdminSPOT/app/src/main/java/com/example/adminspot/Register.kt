...
import com.example.adminspot.databinding.ActivityRegisterBinding
...
class Register : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.adminalreadyhavebutton.setOnClickListener {
    ...
    private fun saveUserData() {
        val admin = AdminModel(username, email, phone = phone)
        val adminId = FirebaseAuth.getInstance().currentUser!!.uid
        // Save admin data into Firebase database
